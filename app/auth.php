...
$user = array(
    'USER_LOGIN' => 'jack.royal2020256@gmail.com', // Ваш логин (электронная почта)
    'USER_HASH' => 'cd14a4a4bc47a07ac5053df58c5301cf9d68243c', // Хэш для доступа к API (смотрите в профиле пользователя)
);
...
curl_setopt(
    $curl, CURLOPT_COOKIEFILE, dirname(__FILE__) . '/cookie.txt'
); // PHP>5.3.6 dirname(__FILE__) -> __DIR__
curl_setopt(
    $curl, CURLOPT_COOKIEJAR, dirname(__FILE__) . '/cookie.txt'
); // PHP>5.3.6 dirname(__FILE__) -> __DIR__
